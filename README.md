...
Limpa os textos, removendo toda a sujeira
Transforma cada notícia em um vetor numérico que representa o seu significado
Busca as notícias mais relevantes para uma pergunta feita em português
Como rodar
1. Instalar as dependências
pip install -r requirements.txt

2. Rodar as etapas na ordem
python etapa1_limpeza.py python etapa2_embeddings.py python etapa3_busca.py
...
Transforma a sua pergunta em um vetor, usando o mesmo método da etapa 2
Compara esse vetor com o vetor de cada notícia
Retorna as 3 notícias com maior similaridade, junto com o score e um trecho relevante
Resultados
